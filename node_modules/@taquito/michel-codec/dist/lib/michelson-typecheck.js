...
function functionTypeInternal(inst, stack, ctx) {
    ...
    var retStack = (function (instruction) {
        ...
        switch (instruction.prim) {
            ...
            case "CDR":
                {
                    var s = utils_1.unpackComb("pair", args(0, ["pair"])[0]);
            ...
            case "ADDRESS":
                {
                    ...
                    var ia = instructionAnn({ v: 1 });
                    return __spread([
                        annotate((_a = { prim: "address" }, _a[michelson_types_1.refContract] = s, _a), { v: ia.v ? ia.v : varSuffix(argAnn(s), "address") })
                    ], stack.slice(1));
                }
            case "SELF_ADDRESS":
                {
            ...
            case "CONTRACT":
                {
                    ...
                    var contract = s[michelson_types_1.refContract];
            ...
            case "SPLIT_TICKET":
                {
                    ...
                    var p = utils_1.unpackComb("pair", s[1]);
