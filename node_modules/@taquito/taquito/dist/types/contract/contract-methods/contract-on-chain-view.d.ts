...
export declare class OnChainView {
    ...
    private _contractStorageValue;
    private _args;
    constructor(_rpc: RpcClientInterface, _contractAddress: string, _smartContractViewSchema: ViewSchema, _contractStorageType: MichelsonV1Expression, _contractStorageValue: MichelsonV1Expression, _args?: any);
    /**
