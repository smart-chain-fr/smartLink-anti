                ...
                switch (_c.label) {
                    ...
                    case 4:
                        ...
                        if (Object.keys(globalconstantsHashAndValue).length !== 0) {
                            p = new michel_codec_1.Parser({ expandGlobalConstant: globalconstantsHashAndValue });
                            storageTypeNoGlobalConst = p.parseJSON(storageType.args[0]);
                            schemaNoGlobalConst = new michelson_encoder_1.Schema(storageTypeNoGlobalConst);
