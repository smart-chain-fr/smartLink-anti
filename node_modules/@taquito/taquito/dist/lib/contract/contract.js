...
var contract_method_factory_1 = require("./contract-methods/contract-method-factory");
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        else if (this.chainId === constants_1.ChainIds.IDIAZABALNET) {
                            lambdaAddress = constants_1.DefaultLambdaAddresses.IDIAZABALNET;
                        }
