            ...
            return __generator(this, function (_o) {
                switch (_o.label) {
                    ...
                    case 5:
                        ...
                        _a = param.kind;
                        switch (_a) {
                            case rpc_1.OpKind.TRANSACTION: return [3 /*break*/, 6];
                            case rpc_1.OpKind.ORIGINATION: return [3 /*break*/, 8];
                            case rpc_1.OpKind.DELEGATION: return [3 /*break*/, 11];
                            case rpc_1.OpKind.ACTIVATION: return [3 /*break*/, 13];
                            case rpc_1.OpKind.REGISTER_GLOBAL_CONSTANT: return [3 /*break*/, 14];
                        }
                        return [3 /*break*/, 16];
                    case 6:
                    ...
                    case 14:
                        ...
                        return [4 /*yield*/, prepare_1.createRegisterGlobalConstantOperation(__assign(__assign({}, param), mergeLimits(param, DEFAULT_PARAMS)))];
                    case 15:
                        _k.apply(_j, [_o.sent()]);
                        return [3 /*break*/, 17];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 3:
                        DEFAULT_PARAMS = _c.sent();
                        return [4 /*yield*/, prepare_1.createRegisterGlobalConstantOperation(__assign(__assign({}, rest), mergeLimits({ fee: fee, storageLimit: storageLimit, gasLimit: gasLimit }, DEFAULT_PARAMS)))];
                    case 4:
                        op = _c.sent();
                        return [4 /*yield*/, this.isRevealOpNeeded([op], pkh)];
                    case 5:
